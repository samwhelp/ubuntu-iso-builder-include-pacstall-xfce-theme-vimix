...
> [ubuntu-iso-builder-include-pacstall-xfce-theme-vimix](https://samwhelp.github.io/ubuntu-iso-builder-include-pacstall-xfce-theme-vimix/)
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-include-pacstall-xfce-theme-vimix/tree/main/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-include-pacstall-xfce-theme-vimix/tree/main/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-include-pacstall-xfce-theme-vimix/tree/main/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-include-pacstall-xfce-theme-vimix](https://github.com/samwhelp/ubuntu-iso-builder-include-pacstall-xfce-theme-vimix)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-include-pacstall-xfce-theme-vimix.git
```


> change dir to `ubuntu-iso-builder-include-pacstall-xfce-theme-vimix`

``` sh
cd ubuntu-iso-builder-include-pacstall-xfce-theme-vimix
```
...
> The resulting ISO file will be placed on `ubuntu-iso-builder-remix-xfce/dist`
